 ...
 * Continuous
 *
 * The Continuous output layer consists of multiple linear neuron that outputs a real vector.
 *
 * @internal
 *
 ...
 */
class MultiContinuous implements Output
{
    /**
     ...
     *
     * @param (list<int>|list<float>)[] $labels
